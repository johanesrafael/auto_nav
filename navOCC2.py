...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 14:42:17 2020
...
#                    rospy.loginfo(range(int(angle)-25,int(angle)-20)+range(int(angle)+20,int(angle)+26))
                    ...
                    if special==True:
                        if angle>0:
                            arr=range(int(angle)-30,int(angle)-25)
                        else:
                            arr=range(int(angle)+25,int(angle)+31)
                    else:
#                        arr=range(int(angle)-25,int(angle)-20)+range(int(angle)+20,int(angle)+26)

                        if angle<0:
                            if angle-25<-180:
                                arr=range(int(angle)+25,int(angle)+31) +[-179]
                            else:
                                arr=range(int(angle)-30,int(angle)-25)+range(int(angle)+25,int(angle)+31)
                        elif angle>0:
                            if angle+25>180:
                                arr=range(int(angle)-30,int(angle)-25) +[179]
                            else:
                                arr=range(int(angle)-30,int(angle)-25)+range(int(angle)+25,int(angle)+31)
...
#                    rospy.loginfo(str(lr2i))
                        ...
                        if special==True:
                            ...
                            if angle<0:
                                if angle-25<-180:
                                    arr=range(int(angle)+20,int(angle)+26) +[-179]
                                else:
                                    arr=range(int(angle)-25,int(angle)-20)+range(int(angle)+20,int(angle)+26)
                            elif angle>0:
                                if angle+25>180:
                                    arr=range(int(angle)-25,int(angle)-20) +[179]
                                else:
                                    arr=range(int(angle)-25,int(angle)-20)+range(int(angle)+20,int(angle)+26)
                        rospy.loginfo(arr)
                        distarray=[]
