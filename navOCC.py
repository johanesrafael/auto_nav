...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 18 16:29:33 2020
...
#                        arr=range(int(angle)-25,int(angle)-20)+range(int(angle)+20,int(angle)+26)
                    ...
                    rotatebot(float(arg))
                    time.sleep(0.1)
                    frontD=np.amin(laser_range[0,range(-3,4)])
                    if np.amin(laser_range[0,range(85,95)])<0.3:
                        ...
                        if arg>0:
                            if arg>90:
                                rotatebotSlow(-3)
                                if np.amin(laser_range[0,range(-3,4)])<frontD:
                                    rotatebotSlow(3)
                            else:
